...
export const mockReports: Report[] = [
  { id: 'r1', reporter: 'jade@example.com', reporterHandle: 'jadekim', type: 'stream', target: 'Tyler Banks', targetHandle: 'tylerb', reason: 'Explicit language and nudity', description: 'During the stream the user repeatedly used extreme profanity and briefly exposed themselves to the camera around the 47-minute mark. Several viewers left comments flagging the moment. The stream was not terminated by the platform.', reportedAt: '2026-06-03T19:12:00Z', status: 'pending' },
  { id: 'r2', reporter: 'elena@example.com', reporterHandle: 'elenapopov', type: 'user', target: 'Carlos Duarte', targetHandle: 'cduarte', reason: 'Harassment in DMs', description: 'Reporter received a series of unsolicited DMs containing threats and insults after declining to follow the user. Screenshots were attached in the original report. The messages escalated over approximately 20 minutes before the reporter blocked the account.', reportedAt: '2026-06-03T17:40:00Z', status: 'resolved' },
  { id: 'r3', reporter: 'priya@example.com', reporterHandle: 'priyanair', type: 'message', target: 'Tyler Banks', targetHandle: 'tylerb', reason: 'Spam messages in chat', description: 'The user flooded a live stream chat with repeated identical promotional messages linking to an external site. Approximately 40 messages were sent within 3 minutes, drowning out normal chat interaction. Other viewers also complained in the stream.', reportedAt: '2026-06-03T16:55:00Z', status: 'pending' },
  { id: 'r4', reporter: 'finn@example.com', reporterHandle: 'finno', type: 'stream', target: 'Aria Voss', targetHandle: 'ariavoss', reason: 'Copyright music playing', description: 'The entire 2.5-hour stream used commercially licensed background music without apparent permission. Tracks identified include well-known releases from major labels. Reporter noted this has happened in at least two previous streams.', reportedAt: '2026-06-02T22:30:00Z', status: 'dismissed' },
  { id: 'r5', reporter: 'marco@example.com', reporterHandle: 'marcoreyes', type: 'user', target: 'Carlos Duarte', targetHandle: 'cduarte', reason: 'Impersonation of a creator', description: 'The account profile photo and display name closely mimic a verified creator on the platform. The bio also copies wording from the original creator\'s profile almost verbatim. Several users reportedly mistook the account for the real creator and sent gifts.', reportedAt: '2026-06-02T14:10:00Z', status: 'resolved' },
  { id: 'r6', reporter: 'aria@example.com', reporterHandle: 'ariavoss', type: 'message', target: 'Finn O\'Brien', targetHandle: 'finno', reason: 'Inappropriate comments', description: 'User posted several sexually suggestive comments directed at the streamer in the live chat. The comments were visible to all viewers including potentially minors in the audience. The streamer manually deleted some but the user continued posting.', reportedAt: '2026-06-02T11:00:00Z', status: 'pending' },
  { id: 'r7', reporter: 'tyler@example.com', reporterHandle: 'tylerb', type: 'stream', target: 'Sasha Bloom', targetHandle: 'sashabloom', reason: 'False flagging competitor', description: 'Reporter believes this report was submitted in bad faith to disrupt a competing streamer\'s broadcast. The reported stream contained no policy-violating content. The reporter\'s account has a history of flagging the same target multiple times within short periods.', reportedAt: '2026-06-01T20:00:00Z', status: 'dismissed' },
  { id: 'r8', reporter: 'nour@example.com', reporterHandle: 'nourar', type: 'user', target: 'Priya Nair', targetHandle: 'priyanair', reason: 'Bot account suspicion', description: 'The account shows unusual activity patterns: 800 follows added within 15 minutes, comment posts at a rate inconsistent with human input, and wallet transactions at regular 30-second intervals. The account was created 4 days ago.', reportedAt: '2026-06-01T09:30:00Z', status: 'pending' },
  { id: 'r9', reporter: 'sasha@example.com', reporterHandle: 'sashabloom', type: 'message', target: 'Marco Reyes', targetHandle: 'marcoreyes', reason: 'Soliciting in chat', description: 'User posted repeated messages in the stream chat asking viewers to send payments to an external platform in exchange for exclusive content. Included a link to a third-party payment page. The behaviour matches a known pattern of off-platform solicitation.', reportedAt: '2026-05-31T21:15:00Z', status: 'resolved' },
  { id: 'r10', reporter: 'jade@example.com', reporterHandle: 'jadekim', type: 'user', target: 'Elena Popov', targetHandle: 'elenapopov', reason: 'Underage user suspicion', description: 'The user\'s profile indicates they are 14 years old. They have been present in 18+ tagged streams and have sent gifts to adult-content creators. Reporter noted the profile birthday was entered as 2011. KYC has not been completed for this account.', reportedAt: '2026-05-31T18:00:00Z', status: 'pending' },
  { id: 'r11', reporter: 'carlos@example.com', reporterHandle: 'cduarte', type: 'stream', target: 'Nour Al-Rashid', targetHandle: 'nourar', reason: 'Misleading stream title', description: 'Stream was titled "GIVEAWAY — 10,000 coins to random viewer!" but no giveaway took place. Several users joined specifically for the giveaway and complained in chat. The streamer dismissed the complaints and ended the stream without acknowledging the misleading title.', reportedAt: '2026-05-30T15:45:00Z', status: 'dismissed' },
  { id: 'r12', reporter: 'priya@example.com', reporterHandle: 'priyanair', type: 'message', target: 'Sasha Bloom', targetHandle: 'sashabloom', reason: 'Offensive emote spam', description: 'User combined platform emotes in sequences that formed offensive phrases directed at specific viewers in the chat. The emote combinations circumvent the standard text filter. Multiple other viewers flagged the same behaviour in the same session.', reportedAt: '2026-05-30T12:20:00Z', status: 'resolved' },
];
...
export const mockTransactions: Transaction[] = [
  ...
  { id: 't4',  user: 'Sasha Bloom',    userHandle: 'sashabloom', type: 'diamond_received',   amount: 60000,  currency: 'diamonds', date: '2026-06-03T19:30:00Z', note: 'Dragon gift from @priyanair' },
  { id: 't5',  user: 'Sasha Bloom',    userHandle: 'sashabloom', type: 'diamond_withdrawal', amount: 80000,  currency: 'diamonds', date: '2026-06-03T10:00:00Z', note: 'Withdrawal request · est. $56' },
  { id: 't6',  user: 'Marco Reyes',    userHandle: 'marcoreyes', type: 'diamond_withdrawal', amount: 30000,  currency: 'diamonds', date: '2026-06-01T09:00:00Z', note: 'Withdrawal approved · $21' },
  ...
  { id: 't9',  user: 'Aria Voss',      userHandle: 'ariavoss',   type: 'diamond_received',   amount: 8000,   currency: 'diamonds', date: '2026-05-31T22:10:00Z', note: 'Trophy gift from @jadekim' },
  { id: 'tx1', user: 'Sasha Bloom',    userHandle: 'sashabloom', type: 'diamond_received',   amount: 100000, currency: 'diamonds', date: '2026-05-30T21:00:00Z', note: 'Castle gift from @whalekid during Sunday stream' },
  { id: 'tx2', user: 'Sasha Bloom',    userHandle: 'sashabloom', type: 'diamond_received',   amount: 70000,  currency: 'diamonds', date: '2026-05-25T18:30:00Z', note: 'Yacht gift from @topfan99' },
  { id: 'tx3', user: 'Sasha Bloom',    userHandle: 'sashabloom', type: 'diamond_withdrawal', amount: 200000, currency: 'diamonds', date: '2026-05-20T10:00:00Z', note: 'Withdrawal est. $140 — flagged & rejected' },
  { id: 'tx4', user: 'Aria Voss',      userHandle: 'ariavoss',   type: 'diamond_withdrawal', amount: 100000, currency: 'diamonds', date: '2026-05-28T11:00:00Z', note: 'Withdrawal est. $70 — flagged & approved' },
  { id: 'tx5', user: 'Aria Voss',      userHandle: 'ariavoss',   type: 'diamond_received',   amount: 55000,  currency: 'diamonds', date: '2026-05-27T20:00:00Z', note: 'Dragon gift during GRWM stream' },
  { id: 'tx6', user: 'Aria Voss',      userHandle: 'ariavoss',   type: 'diamond_received',   amount: 22100,  currency: 'diamonds', date: '2026-05-20T17:00:00Z', note: 'Multiple gifts — Q&A session' },
  { id: 'tx7', user: 'Nour Al-Rashid', userHandle: 'nourar',     type: 'diamond_received',   amount: 120000, currency: 'diamonds', date: '2026-06-05T20:00:00Z', note: 'Yacht + Castle during cooking stream' },
  { id: 'tx8', user: 'Nour Al-Rashid', userHandle: 'nourar',     type: 'diamond_withdrawal', amount: 120000, currency: 'diamonds', date: '2026-06-06T09:00:00Z', note: 'Withdrawal est. $84 — flagged' },
  { id: 'tx9', user: 'Nour Al-Rashid', userHandle: 'nourar',     type: 'diamond_received',   amount: 8800,   currency: 'diamonds', date: '2026-06-03T22:10:00Z', note: 'Regular viewer gifts during stream' },
  { id: 'tx10',user: 'Nour Al-Rashid', userHandle: 'nourar',     type: 'diamond_received',   amount: 31400,  currency: 'diamonds', date: '2026-05-30T20:00:00Z', note: 'VS Battle night gifts' },
  { id: 'tx11',user: 'Jade Kim',       userHandle: 'jadekim',    type: 'coin_purchase',      amount: 19.99,  currency: 'USD',      date: '2026-05-28T14:00:00Z', note: '2,500 coins via App Store' },
  { id: 'tx12',user: 'Elena Popov',    userHandle: 'elenapopov', type: 'coin_purchase',      amount: 9.99,   currency: 'USD',      date: '2026-05-25T11:00:00Z', note: '1,200 coins via Play Store' },
];
