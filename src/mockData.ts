...
export const mockWithdrawals: WithdrawalRequest[] = [
  ...
  { id: 'w7',  user: 'Luna Star',      userHandle: 'lunastar',    diamonds: 45000,  estimatedUSD: 157.50, kycStatus: 'approved', requestedAt: '2026-05-27T08:00:00Z', holdUntil: '2026-06-03T08:00:00Z', status: 'approved', avatarColor: '#9B111E' },
  ...
  { id: 'w9',  user: 'Zoe Chen',       userHandle: 'zoechen',     diamonds: 60000,  estimatedUSD: 210,    kycStatus: 'approved', requestedAt: '2026-05-25T12:00:00Z', holdUntil: '2026-06-01T12:00:00Z', status: 'rejected', avatarColor: '#9966CC' },
  { id: 'w10', user: 'Dex Volta',      userHandle: 'dexvolta',    diamonds: 35000,  estimatedUSD: 122.50, kycStatus: 'approved', requestedAt: '2026-05-24T09:45:00Z', holdUntil: '2026-05-31T09:45:00Z', status: 'approved', avatarColor: '#D4AF37' },
  ...
  { id: 'w12', user: 'Rio Blaze',      userHandle: 'rioblaze',    diamonds: 18000,  estimatedUSD: 63,     kycStatus: 'approved', requestedAt: '2026-05-22T11:00:00Z', holdUntil: '2026-05-29T11:00:00Z', status: 'approved', avatarColor: '#C0392B' },
  { id: 'w13', user: 'Priya Nair',     userHandle: 'priyanair',   diamonds: 55000,  estimatedUSD: 192.50, kycStatus: 'approved', requestedAt: '2026-05-21T14:00:00Z', holdUntil: '2026-05-28T14:00:00Z', status: 'rejected', avatarColor: '#9B111E' },
  { id: 'w14', user: 'Carlos Duarte',  userHandle: 'cduarte',     diamonds: 25000,  estimatedUSD: 87.50,  kycStatus: 'rejected', requestedAt: '2026-05-20T10:30:00Z', holdUntil: '2026-05-27T10:30:00Z', status: 'rejected', avatarColor: '#48484A' },
  { id: 'w15', user: 'Elena Popov',    userHandle: 'elenapopov',  diamonds: 40000,  estimatedUSD: 140,    kycStatus: 'approved', requestedAt: '2026-05-19T16:00:00Z', holdUntil: '2026-05-26T16:00:00Z', status: 'approved', avatarColor: '#9966CC' },
  { id: 'w16', user: 'Jade Kim',       userHandle: 'jadekim',     diamonds: 10000,  estimatedUSD: 35,     kycStatus: 'approved', requestedAt: '2026-05-18T09:00:00Z', holdUntil: '2026-05-25T09:00:00Z', status: 'approved', avatarColor: '#D4AF37' },
  ...
  { id: 'w18', user: 'Sasha Bloom',    userHandle: 'sashabloom',  diamonds: 120000, estimatedUSD: 420,    kycStatus: 'approved', requestedAt: '2026-05-16T08:00:00Z', holdUntil: '2026-05-23T08:00:00Z', status: 'approved', avatarColor: '#9966CC' },
  { id: 'w19', user: 'Marco Reyes',    userHandle: 'marcoreyes',  diamonds: 11000,  estimatedUSD: 38.50,  kycStatus: 'approved', requestedAt: '2026-05-15T18:45:00Z', holdUntil: '2026-05-22T18:45:00Z', status: 'rejected', avatarColor: '#2ECC8A' },
  { id: 'w20', user: 'Nour Al-Rashid', userHandle: 'nourar',      diamonds: 90000,  estimatedUSD: 315,    kycStatus: 'approved', requestedAt: '2026-05-14T11:15:00Z', holdUntil: '2026-05-21T11:15:00Z', status: 'approved', avatarColor: '#D4AF37' },
  ...
  { id: 'w22', user: 'Kai Rivers',     userHandle: 'kairivs',     diamonds: 48000,  estimatedUSD: 168,    kycStatus: 'approved', requestedAt: '2026-05-12T09:30:00Z', holdUntil: '2026-05-19T09:30:00Z', status: 'approved', avatarColor: '#2ECC8A' },
];
