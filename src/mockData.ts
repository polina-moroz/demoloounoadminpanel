...
export const mockTransactions: Transaction[] = [
  { id: 't1',  user: 'Jade Kim',       userHandle: 'jadekim',    type: 'coin_purchase',    amount: 9.99,   currency: 'USD',      date: '2026-06-03T20:10:00Z', note: '2,000 coins via App Store',      status: 'approved' },
  { id: 't2',  user: 'Elena Popov',    userHandle: 'elenapopov', type: 'coin_purchase',    amount: 9.99,   currency: 'USD',      date: '2026-06-03T19:45:00Z', note: '1,400 coins via Play Store',      status: 'approved' },
  { id: 't3',  user: 'Tyler Banks',    userHandle: 'tylerb',     type: 'coin_purchase',    amount: 49.99,  currency: 'USD',      date: '2026-06-03T18:20:00Z', note: '11,000 coins via App Store â€” card declined', status: 'failed' },
  { id: 't4',  user: 'Sasha Bloom',    userHandle: 'sashabloom', type: 'diamonds_received', amount: 60000,  currency: 'diamonds', date: '2026-06-03T19:30:00Z', note: 'Diamond Storm gift from @priyanair', status: 'approved' },
  { id: 't5',  user: 'Sasha Bloom',    userHandle: 'sashabloom', type: 'withdrawal',        amount: 80000,  currency: 'diamonds', date: '2026-06-03T10:00:00Z', note: 'Withdrawal request Â· est. $280', status: 'pending' },
  { id: 't6',  user: 'Marco Reyes',    userHandle: 'marcoreyes', type: 'withdrawal',        amount: 30000,  currency: 'diamonds', date: '2026-06-01T09:00:00Z', note: 'Withdrawal approved Â· $105', status: 'approved' },
  { id: 't7',  user: "Finn O'Brien",   userHandle: 'finno',      type: 'coin_purchase',    amount: 9.99,   currency: 'USD',      date: '2026-06-01T08:00:00Z', note: '1,400 coins via App Store', status: 'approved' },
  { id: 't9',  user: 'Aria Voss',      userHandle: 'ariavoss',   type: 'diamonds_received', amount: 8000,   currency: 'diamonds', date: '2026-05-31T22:10:00Z', note: 'Rocket gift from @jadekim', status: 'approved' },
  { id: 'tx1', user: 'Sasha Bloom',    userHandle: 'sashabloom', type: 'diamonds_received', amount: 100000, currency: 'diamonds', date: '2026-05-30T21:00:00Z', note: 'Cosmic Castle gift from @whalekid during Sunday stream', status: 'approved' },
  { id: 'tx2', user: 'Sasha Bloom',    userHandle: 'sashabloom', type: 'diamonds_received', amount: 70000,  currency: 'diamonds', date: '2026-05-25T18:30:00Z', note: 'Royal Yacht gift from @topfan99', status: 'approved' },
  { id: 'tx3', user: 'Sasha Bloom',    userHandle: 'sashabloom', type: 'withdrawal',        amount: 200000, currency: 'diamonds', date: '2026-05-20T10:00:00Z', note: 'Withdrawal est. $700 â€” flagged & rejected', status: 'rejected' },
  { id: 'tx4', user: 'Aria Voss',      userHandle: 'ariavoss',   type: 'withdrawal',        amount: 100000, currency: 'diamonds', date: '2026-05-28T11:00:00Z', note: 'Withdrawal est. $350 â€” flagged & approved', status: 'approved' },
  { id: 'tx5', user: 'Aria Voss',      userHandle: 'ariavoss',   type: 'diamonds_received', amount: 55000,  currency: 'diamonds', date: '2026-05-27T20:00:00Z', note: 'Royal Fortress gift during GRWM stream', status: 'approved' },
  { id: 'tx6', user: 'Aria Voss',      userHandle: 'ariavoss',   type: 'diamonds_received', amount: 22100,  currency: 'diamonds', date: '2026-05-20T17:00:00Z', note: 'Multiple gifts â€” Q&A session', status: 'approved' },
  { id: 'tx7', user: 'Nour Al-Rashid', userHandle: 'nourar',     type: 'diamonds_received', amount: 120000, currency: 'diamonds', date: '2026-06-05T20:00:00Z', note: 'Nebula Nova + Cosmic Castle during cooking stream', status: 'approved' },
  { id: 'tx8', user: 'Nour Al-Rashid', userHandle: 'nourar',     type: 'withdrawal',        amount: 120000, currency: 'diamonds', date: '2026-06-06T09:00:00Z', note: 'Withdrawal est. $420 â€” flagged', status: 'pending' },
  { id: 'tx9', user: 'Nour Al-Rashid', userHandle: 'nourar',     type: 'diamonds_received', amount: 8800,   currency: 'diamonds', date: '2026-06-03T22:10:00Z', note: 'Regular viewer gifts during stream', status: 'approved' },
  { id: 'tx10',user: 'Nour Al-Rashid', userHandle: 'nourar',     type: 'diamonds_received', amount: 31400,  currency: 'diamonds', date: '2026-05-30T20:00:00Z', note: 'VS Battle night gifts', status: 'approved' },
  { id: 'tx11',user: 'Jade Kim',       userHandle: 'jadekim',    type: 'coin_purchase',    amount: 19.99,  currency: 'USD',      date: '2026-05-28T14:00:00Z', note: '4,000 coins via App Store', status: 'approved' },
  { id: 'tx12',user: 'Elena Popov',    userHandle: 'elenapopov', type: 'coin_purchase',    amount: 9.99,   currency: 'USD',      date: '2026-05-25T11:00:00Z', note: '1,400 coins via Play Store', status: 'approved' },
];
...
export const mockGifts: Gift[] = [
  ...
  { id: 'g1',  animationFileName: 'thumbs_up.json',    name: 'Thumbs Up',     coins: 10,  tier: '5A', tierName: 'Reaction / Meme', durationSec: 1,  enabled: true,  vipExclusive: false, minVipLevel: null },
  { id: 'g2',  animationFileName: 'heart.json',         name: 'Heart',         coins: 25,  tier: '5A', tierName: 'Reaction / Meme', durationSec: 1,  enabled: true,  vipExclusive: false, minVipLevel: null },
  { id: 'g3',  animationFileName: 'clap.json',          name: 'Clap',          coins: 50,  tier: '5A', tierName: 'Reaction / Meme', durationSec: 2,  enabled: true,  vipExclusive: false, minVipLevel: null },
  { id: 'g4',  animationFileName: 'lol.json',           name: 'LOL',           coins: 100, tier: '5A', tierName: 'Reaction / Meme', durationSec: 2,  enabled: true,  vipExclusive: false, minVipLevel: null },
  { id: 'g5',  animationFileName: 'fire.json',          name: 'Fire',          coins: 250, tier: '5A', tierName: 'Reaction / Meme', durationSec: 2,  enabled: true,  vipExclusive: false, minVipLevel: null },
  { id: 'g6',  animationFileName: 'diamond_spark.json', name: 'Diamond Spark', coins: 500, tier: '5A', tierName: 'Reaction / Meme', durationSec: 2,  enabled: true,  vipExclusive: false, minVipLevel: null },
  // 5B â€” Mid-Tier (3â€“5s, 300â€“3,000 coins)
  { id: 'g7',  animationFileName: 'rocket.json',         name: 'Rocket',        coins: 300,  tier: '5B', tierName: 'Mid-Tier', durationSec: 3,  enabled: true,  vipExclusive: false, minVipLevel: null },
  { id: 'g8',  animationFileName: 'confetti.json',       name: 'Confetti',      coins: 800,  tier: '5B', tierName: 'Mid-Tier', durationSec: 4,  enabled: true,  vipExclusive: false, minVipLevel: null },
  { id: 'g9',  animationFileName: 'shooting_star.json',  name: 'Shooting Star', coins: 1500, tier: '5B', tierName: 'Mid-Tier', durationSec: 4,  enabled: true,  vipExclusive: false, minVipLevel: null },
  { id: 'g10', animationFileName: 'crystal_ball.json',   name: 'Crystal Ball',  coins: 3000, tier: '5B', tierName: 'Mid-Tier', durationSec: 5,  enabled: true,  vipExclusive: false, minVipLevel: null },
  // 5C â€” Premium (6â€“10s, 8,000â€“70,000 coins)
  { id: 'g11', animationFileName: 'golden_dragon.json',  name: 'Golden Dragon',   coins: 8000,  tier: '5C', tierName: 'Premium', durationSec: 6,  enabled: true,  vipExclusive: false, minVipLevel: null },
  { id: 'g12', animationFileName: 'rainbow_phoenix.json',name: 'Rainbow Phoenix',  coins: 20000, tier: '5C', tierName: 'Premium', durationSec: 8,  enabled: true,  vipExclusive: false, minVipLevel: null },
  { id: 'g13', animationFileName: 'crystal_palace.json', name: 'Crystal Palace',   coins: 45000, tier: '5C', tierName: 'Premium', durationSec: 9,  enabled: true,  vipExclusive: false, minVipLevel: null },
  { id: 'g14', animationFileName: 'royal_yacht.json',    name: 'Royal Yacht',      coins: 70000, tier: '5C', tierName: 'Premium', durationSec: 10, enabled: true,  vipExclusive: false, minVipLevel: null },
  // 5D â€” Cinematic / Whale (12â€“15s, 90,000â€“150,000 coins)
  { id: 'g15', animationFileName: 'diamond_storm.json',  name: 'Diamond Storm',    coins: 90000,  tier: '5D', tierName: 'Cinematic / Whale', durationSec: 12, enabled: true,  vipExclusive: false, minVipLevel: null },
  { id: 'g16', animationFileName: 'galactic_explosion.json', name: 'Galactic Explosion', coins: 120000, tier: '5D', tierName: 'Cinematic / Whale', durationSec: 14, enabled: true,  vipExclusive: false, minVipLevel: null },
  { id: 'g17', animationFileName: 'cosmic_castle.json',  name: 'Cosmic Castle',    coins: 150000, tier: '5D', tierName: 'Cinematic / Whale', durationSec: 15, enabled: false, vipExclusive: false, minVipLevel: null },
  // 5E â€” VIP / Max Cap (16â€“20s, 175,000â€“300,000 coins)
  { id: 'g18', animationFileName: 'royal_fortress.json', name: 'Royal Fortress',   coins: 175000, tier: '5E', tierName: 'VIP / Max Cap', durationSec: 16, enabled: true,  vipExclusive: false, minVipLevel: null },
];

// VIP Gifts â€” fixed category, rank-gated by minimum VIP level, not a deletable/editable tier like the ones above
export const mockVIPGifts: Gift[] = [
  { id: 'g19', animationFileName: 'nebula_nova.json',    name: 'Nebula Nova',      coins: 200000, tier: 'vip', tierName: 'VIP Gifts', durationSec: 18, enabled: true, vipExclusive: true, minVipLevel: 4 },
  { id: 'g20', animationFileName: 'infinity_crown.json', name: 'Infinity Crown',   coins: 300000, tier: 'vip', tierName: 'VIP Gifts', durationSec: 20, enabled: true, vipExclusive: true, minVipLevel: 5 },
];
...
export const mockCPTiers: PrestigeCPTier[] = [
  // Bronze
  { id: 'cp1',  tier: 'Bronze',          subTier: 'I',   cpFrom: 0,           cpTo: 18750,       color: '#CD7F32', badgeColor: '#CD7F32', iconFileName: null, perks: [{ type: 'other', label: 'Basic streamer badge on profile' }] },
  { id: 'cp2',  tier: 'Bronze',          subTier: 'II',  cpFrom: 18751,       cpTo: 37500,       color: '#CD7F32', badgeColor: '#CD7F32', iconFileName: null, perks: [{ type: 'animated_badge' }, { type: 'other', label: 'Tier badge on stream overlay' }] },
  { id: 'cp3',  tier: 'Bronze',          subTier: 'III', cpFrom: 37501,       cpTo: 56250,       color: '#CD7F32', badgeColor: '#CD7F32', iconFileName: null, perks: [{ type: 'other', label: 'Access to animated overlays Tier 1' }] },
  { id: 'cp4',  tier: 'Bronze',          subTier: 'IV',  cpFrom: 56251,       cpTo: 75000,       color: '#CD7F32', badgeColor: '#CD7F32', iconFileName: null, perks: [{ type: 'discovery_boost', value: 2 }] },
  // Silver
  { id: 'cp5',  tier: 'Silver',          subTier: 'I',   cpFrom: 75001,       cpTo: 143750,      color: '#C0C0C0', badgeColor: '#C0C0C0', iconFileName: null, perks: [{ type: 'other', label: 'Silver ring on profile' }] },
  { id: 'cp6',  tier: 'Silver',          subTier: 'II',  cpFrom: 143751,      cpTo: 212500,      color: '#C0C0C0', badgeColor: '#C0C0C0', iconFileName: null, perks: [{ type: 'discovery_boost', value: 5 }] },
  { id: 'cp7',  tier: 'Silver',          subTier: 'III', cpFrom: 212501,      cpTo: 281250,      color: '#C0C0C0', badgeColor: '#C0C0C0', iconFileName: null, perks: [{ type: 'other', label: 'Priority in search results' }] },
  { id: 'cp8',  tier: 'Silver',          subTier: 'IV',  cpFrom: 281251,      cpTo: 350000,      color: '#C0C0C0', badgeColor: '#C0C0C0', iconFileName: null, perks: [{ type: 'exclusive_emote_pack' }] },
  // Gold
  { id: 'cp9',  tier: 'Gold',            subTier: 'I',   cpFrom: 350001,      cpTo: 512500,      color: '#D4AF37', badgeColor: '#D4AF37', iconFileName: null, perks: [{ type: 'animated_badge' }] },
  { id: 'cp10', tier: 'Gold',            subTier: 'II',  cpFrom: 512501,      cpTo: 675000,      color: '#D4AF37', badgeColor: '#D4AF37', iconFileName: null, perks: [{ type: 'discovery_boost', value: 15 }] },
  { id: 'cp11', tier: 'Gold',            subTier: 'III', cpFrom: 675001,      cpTo: 837500,      color: '#D4AF37', badgeColor: '#D4AF37', iconFileName: null, perks: [{ type: 'featured_on_discover' }] },
  { id: 'cp12', tier: 'Gold',            subTier: 'IV',  cpFrom: 837501,      cpTo: 1000000,     color: '#D4AF37', badgeColor: '#D4AF37', iconFileName: null, perks: [{ type: 'exclusive_emote_pack' }] },
  // Platinum
  { id: 'cp13', tier: 'Platinum',        subTier: 'I',   cpFrom: 1000001,     cpTo: 1500000,     color: '#E5E4E2', badgeColor: '#E5E4E2', iconFileName: null, perks: [{ type: 'animated_badge' }] },
  { id: 'cp14', tier: 'Platinum',        subTier: 'II',  cpFrom: 1500001,     cpTo: 2000000,     color: '#E5E4E2', badgeColor: '#E5E4E2', iconFileName: null, perks: [{ type: 'spotlight_slots', value: 1 }] },
  { id: 'cp15', tier: 'Platinum',        subTier: 'III', cpFrom: 2000001,     cpTo: 2500000,     color: '#E5E4E2', badgeColor: '#E5E4E2', iconFileName: null, perks: [{ type: 'exclusive_emote_pack' }] },
  { id: 'cp16', tier: 'Platinum',        subTier: 'IV',  cpFrom: 2500001,     cpTo: 3000000,     color: '#E5E4E2', badgeColor: '#E5E4E2', iconFileName: null, perks: [{ type: 'discovery_boost', value: 25 }] },
  // Sapphire
  { id: 'cp17', tier: 'Sapphire',        subTier: 'I',   cpFrom: 3000001,     cpTo: 4750000,     color: '#0F52BA', badgeColor: '#0F52BA', iconFileName: null, perks: [{ type: 'full_screen_entrance' }] },
  { id: 'cp18', tier: 'Sapphire',        subTier: 'II',  cpFrom: 4750001,     cpTo: 6500000,     color: '#0F52BA', badgeColor: '#0F52BA', iconFileName: null, perks: [{ type: 'priority_support' }, { type: 'spotlight_slots', value: 2 }] },
  { id: 'cp19', tier: 'Sapphire',        subTier: 'III', cpFrom: 6500001,     cpTo: 8250000,     color: '#0F52BA', badgeColor: '#0F52BA', iconFileName: null, perks: [{ type: 'exclusive_gift' }] },
  { id: 'cp20', tier: 'Sapphire',        subTier: 'IV',  cpFrom: 8250001,     cpTo: 10000000,    color: '#0F52BA', badgeColor: '#0F52BA', iconFileName: null, perks: [{ type: 'other', label: 'Co-branded merch drop eligibility' }] },
  // Ruby
  { id: 'cp21', tier: 'Ruby',            subTier: 'I',   cpFrom: 10000001,    cpTo: 13750000,    color: '#E0115F', badgeColor: '#E0115F', iconFileName: null, perks: [{ type: 'full_screen_entrance' }, { type: 'other', label: 'Cinematic stream intro' }] },
  { id: 'cp22', tier: 'Ruby',            subTier: 'II',  cpFrom: 13750001,    cpTo: 17500000,    color: '#E0115F', badgeColor: '#E0115F', iconFileName: null, perks: [{ type: 'exclusive_gift' }] },
  { id: 'cp23', tier: 'Ruby',            subTier: 'III', cpFrom: 17500001,    cpTo: 21250000,    color: '#E0115F', badgeColor: '#E0115F', iconFileName: null, perks: [{ type: 'other', label: 'Monthly admin interview feature' }] },
  { id: 'cp24', tier: 'Ruby',            subTier: 'IV',  cpFrom: 21250001,    cpTo: 25000000,    color: '#E0115F', badgeColor: '#E0115F', iconFileName: null, perks: [{ type: 'account_manager' }] },
  // Amethyst
  { id: 'cp25', tier: 'Amethyst',        subTier: 'I',   cpFrom: 25000001,    cpTo: 31250000,    color: '#9966CC', badgeColor: '#9966CC', iconFileName: null, perks: [{ type: 'full_screen_entrance' }] },
  { id: 'cp26', tier: 'Amethyst',        subTier: 'II',  cpFrom: 31250001,    cpTo: 37500000,    color: '#9966CC', badgeColor: '#9966CC', iconFileName: null, perks: [{ type: 'discovery_boost', value: 40 }] },
  { id: 'cp27', tier: 'Amethyst',        subTier: 'III', cpFrom: 37500001,    cpTo: 43750000,    color: '#9966CC', badgeColor: '#9966CC', iconFileName: null, perks: [{ type: 'exclusive_gift' }] },
  { id: 'cp28', tier: 'Amethyst',        subTier: 'IV',  cpFrom: 43750001,    cpTo: 50000000,    color: '#9966CC', badgeColor: '#9966CC', iconFileName: null, perks: [{ type: 'exclusive_emote_pack' }, { type: 'other', label: 'VIP lounge access' }] },
  // Diamond
  { id: 'cp29', tier: 'Diamond',         subTier: 'I',   cpFrom: 50000001,    cpTo: 58750000,    color: '#B9F2FF', badgeColor: '#B9F2FF', iconFileName: null, perks: [{ type: 'full_screen_entrance' }] },
  { id: 'cp30', tier: 'Diamond',         subTier: 'II',  cpFrom: 58750001,    cpTo: 67500000,    color: '#B9F2FF', badgeColor: '#B9F2FF', iconFileName: null, perks: [{ type: 'spotlight_slots', value: 3 }, { type: 'priority_support' }] },
  { id: 'cp31', tier: 'Diamond',         subTier: 'III', cpFrom: 67500001,    cpTo: 76250000,    color: '#B9F2FF', badgeColor: '#B9F2FF', iconFileName: null, perks: [{ type: 'exclusive_gift' }] },
  { id: 'cp32', tier: 'Diamond',         subTier: 'IV',  cpFrom: 76250001,    cpTo: 85000000,    color: '#B9F2FF', badgeColor: '#B9F2FF', iconFileName: null, perks: [{ type: 'other', label: 'Co-branded platform feature' }] },
  // Black Diamond
  { id: 'cp33', tier: 'Black Diamond',   subTier: 'I',   cpFrom: 85000001,    cpTo: 95000000,    color: '#1E293B', badgeColor: '#1E293B', iconFileName: null, perks: [{ type: 'full_screen_entrance' }] },
  { id: 'cp34', tier: 'Black Diamond',   subTier: 'II',  cpFrom: 95000001,    cpTo: 105000000,   color: '#1E293B', badgeColor: '#1E293B', iconFileName: null, perks: [{ type: 'account_manager' }] },
  { id: 'cp35', tier: 'Black Diamond',   subTier: 'III', cpFrom: 105000001,   cpTo: 115000000,   color: '#1E293B', badgeColor: '#1E293B', iconFileName: null, perks: [{ type: 'other', label: 'Platform billboard feature' }] },
  { id: 'cp36', tier: 'Black Diamond',   subTier: 'IV',  cpFrom: 115000001,   cpTo: 125000000,   color: '#1E293B', badgeColor: '#1E293B', iconFileName: null, perks: [{ type: 'exclusive_gift' }] },
  // Crown Gold
  { id: 'cp37', tier: 'Crown Gold',      subTier: 'I',   cpFrom: 125000001,   cpTo: 137500000,   color: '#C99700', badgeColor: '#C99700', iconFileName: null, perks: [{ type: 'full_screen_entrance' }] },
  { id: 'cp38', tier: 'Crown Gold',      subTier: 'II',  cpFrom: 137500001,   cpTo: 150000000,   color: '#C99700', badgeColor: '#C99700', iconFileName: null, perks: [{ type: 'featured_on_discover' }, { type: 'other', label: 'Lifetime featured placement' }] },
  { id: 'cp39', tier: 'Crown Gold',      subTier: 'III', cpFrom: 150000001,   cpTo: 162500000,   color: '#C99700', badgeColor: '#C99700', iconFileName: null, perks: [{ type: 'other', label: 'Crown Gold exclusive merch collaboration' }] },
  { id: 'cp40', tier: 'Crown Gold',      subTier: 'IV',  cpFrom: 162500001,   cpTo: 175000000,   color: '#C99700', badgeColor: '#C99700', iconFileName: null, perks: [{ type: 'account_manager' }, { type: 'spotlight_slots', value: 1 }] },
  // Imperial Opal
  { id: 'cp41', tier: 'Imperial Opal',   subTier: 'I',   cpFrom: 175000001,   cpTo: 193750000,   color: '#A78BFA', badgeColor: '#A78BFA', iconFileName: null, perks: [{ type: 'full_screen_entrance' }] },
  { id: 'cp42', tier: 'Imperial Opal',   subTier: 'II',  cpFrom: 193750001,   cpTo: 212500000,   color: '#A78BFA', badgeColor: '#A78BFA', iconFileName: null, perks: [{ type: 'other', label: 'Co-branded platform events' }] },
  { id: 'cp43', tier: 'Imperial Opal',   subTier: 'III', cpFrom: 212500001,   cpTo: 231250000,   color: '#A78BFA', badgeColor: '#A78BFA', iconFileName: null, perks: [{ type: 'exclusive_gift' }] },
  { id: 'cp44', tier: 'Imperial Opal',   subTier: 'IV',  cpFrom: 231250001,   cpTo: 250000000,   color: '#A78BFA', badgeColor: '#A78BFA', iconFileName: null, perks: [{ type: 'custom_ring_color' }] },
  // Eclipse Diamond
  { id: 'cp45', tier: 'Eclipse Diamond', subTier: 'I',   cpFrom: 250000001,   cpTo: 275000000,   color: '#4B5563', badgeColor: '#4B5563', iconFileName: null, perks: [{ type: 'full_screen_entrance' }] },
  { id: 'cp46', tier: 'Eclipse Diamond', subTier: 'II',  cpFrom: 275000001,   cpTo: 300000000,   color: '#4B5563', badgeColor: '#4B5563', iconFileName: null, perks: [{ type: 'other', label: 'Lifetime VIP platform partner status' }] },
  { id: 'cp47', tier: 'Eclipse Diamond', subTier: 'III', cpFrom: 300000001,   cpTo: 325000000,   color: '#4B5563', badgeColor: '#4B5563', iconFileName: null, perks: [{ type: 'exclusive_gift' }] },
  { id: 'cp48', tier: 'Eclipse Diamond', subTier: 'IV',  cpFrom: 325000001,   cpTo: 350000000,   color: '#4B5563', badgeColor: '#4B5563', iconFileName: null, perks: [{ type: 'featured_on_discover' }, { type: 'other', label: 'Dedicated creator page on homepage' }] },
  // Loouno Crown
  { id: 'cp49', tier: 'Loouno Crown',    subTier: 'I',   cpFrom: 350000001,   cpTo: 450000000,   color: '#FACC15', badgeColor: '#FACC15', iconFileName: null, perks: [{ type: 'full_screen_entrance' }] },
  { id: 'cp50', tier: 'Loouno Crown',    subTier: 'II',  cpFrom: 450000001,   cpTo: 550000000,   color: '#FACC15', badgeColor: '#FACC15', iconFileName: null, perks: [{ type: 'custom_ring_color' }] },
  { id: 'cp51', tier: 'Loouno Crown',    subTier: 'III', cpFrom: 550000001,   cpTo: 650000000,   color: '#FACC15', badgeColor: '#FACC15', iconFileName: null, perks: [{ type: 'other', label: 'Lifetime VIP Boss + fully negotiated perks' }] },
  { id: 'cp52', tier: 'Loouno Crown',    subTier: 'IV',  cpFrom: 650000001,   cpTo: 750000000,   color: '#FACC15', badgeColor: '#FACC15', iconFileName: null, perks: [{ type: 'other', label: 'Unique on the platform â€” maximum recognition' }] },
];

export const mockVIPLevels: VIPLevel[] = [
  { id: 'vip1', level: 1, name: 'VIP 1', minSpend: 500,   maxSpend: 999,  badgeColor: '#94A3B8', iconFileName: null, perks: [{ type: 'exclusive_emote_pack' }, { type: 'other', label: 'VIP badge, priority chat' }] },
  { id: 'vip2', level: 2, name: 'VIP 2', minSpend: 1000,  maxSpend: 2499, badgeColor: '#FACC15', iconFileName: null, perks: [{ type: 'exclusive_gift' }, { type: 'animated_badge' }] },
  { id: 'vip3', level: 3, name: 'VIP 3', minSpend: 2500,  maxSpend: 4999, badgeColor: '#E5E7EB', iconFileName: null, perks: [{ type: 'animated_badge' }, { type: 'full_screen_entrance' }, { type: 'other', label: 'Chat sparkles' }] },
  { id: 'vip4', level: 4, name: 'VIP 4', minSpend: 5000,  maxSpend: 9999, badgeColor: '#22D3EE', iconFileName: null, perks: [{ type: 'full_screen_entrance' }, { type: 'other', label: 'Private lounge access' }] },
  { id: 'vip5', level: 5, name: 'VIP 5', minSpend: 10000, maxSpend: null, badgeColor: '#111827', iconFileName: null, perks: [{ type: 'full_screen_entrance' }, { type: 'custom_ring_color' }, { type: 'other', label: 'Custom platform recognition' }] },
];
...
export const mockSeasonalWheels: SeasonalWheel[] = [
  {
    ...
    slots: [
      { id: 'sw1s1', kind: 'reward',      rewardName: 'Neon Sunglasses',    coins: 2500,   diamonds: 0 },
      { id: 'sw1s2', kind: 'reward',      rewardName: 'Sliced Watermelon',  coins: 2500,   diamonds: 0 },
      { id: 'sw1s3', kind: 'reward',      rewardName: 'River Tube',         coins: 2500,   diamonds: 0 },
      { id: 'sw1s4', kind: 'small_bonus', rewardName: 'Golden Jet Ski',     coins: 50000,  diamonds: 0 },
      { id: 'sw1s5', kind: 'big_bonus',   rewardName: 'Diamond Sandcastle', coins: 150000, diamonds: 0 },
    ],
  },
  {
    id: 'sw2', name: 'Thanksgiving', active: false, seasonAnimationFileName: null,
    slots: [
      { id: 'sw2s1', kind: 'reward',      rewardName: 'Pumpkin Pie',        coins: 2500,   diamonds: 0 },
      { id: 'sw2s2', kind: 'reward',      rewardName: 'Turkey Leg',         coins: 2500,   diamonds: 0 },
      { id: 'sw2s3', kind: 'reward',      rewardName: 'Falling Leaves',     coins: 2500,   diamonds: 0 },
      { id: 'sw2s4', kind: 'small_bonus', rewardName: 'Golden Cornucopia',  coins: 50000,  diamonds: 0 },
      { id: 'sw2s5', kind: 'big_bonus',   rewardName: 'Diamond Turkey',     coins: 150000, diamonds: 0 },
    ],
  },
  {
    id: 'sw3', name: 'Christmas', active: false, seasonAnimationFileName: null,
    slots: [
      { id: 'sw3s1', kind: 'reward',      rewardName: 'Candy Cane',              coins: 2500,   diamonds: 0 },
      { id: 'sw3s2', kind: 'reward',      rewardName: 'Snowball',                coins: 2500,   diamonds: 0 },
      { id: 'sw3s3', kind: 'reward',      rewardName: 'Stocking',                coins: 2500,   diamonds: 0 },
      { id: 'sw3s4', kind: 'small_bonus', rewardName: 'Gold Sleigh',             coins: 50000,  diamonds: 0 },
      { id: 'sw3s5', kind: 'big_bonus',   rewardName: 'Diamond Christmas Tree',  coins: 150000, diamonds: 0 },
    ],
  },
  {
    id: 'sw4', name: 'Halloween', active: false, seasonAnimationFileName: null,
    slots: [
      { id: 'sw4s1', kind: 'reward',      rewardName: 'Ghost Boo',               coins: 2500,   diamonds: 0 },
      { id: 'sw4s2', kind: 'reward',      rewardName: 'Exploding Bomb',          coins: 2500,   diamonds: 0 },
      { id: 'sw4s3', kind: 'reward',      rewardName: 'Scream Mask',             coins: 2500,   diamonds: 0 },
      { id: 'sw4s4', kind: 'small_bonus', rewardName: 'Golden Grim Reaper',      coins: 50000,  diamonds: 0 },
      { id: 'sw4s5', kind: 'big_bonus',   rewardName: 'Diamond Haunted Mansion', coins: 150000, diamonds: 0 },
    ],
  },
  {
    id: 'sw5', name: 'Valentine', active: false, seasonAnimationFileName: null,
    slots: [
      { id: 'sw5s1', kind: 'reward',      rewardName: 'Heart Eyes',              coins: 2500,   diamonds: 0 },
      { id: 'sw5s2', kind: 'reward',      rewardName: 'Kiss Blow',               coins: 2500,   diamonds: 0 },
      { id: 'sw5s3', kind: 'reward',      rewardName: 'Bouquet Drop',            coins: 2500,   diamonds: 0 },
      { id: 'sw5s4', kind: 'small_bonus', rewardName: 'Golden Teddy Bear',       coins: 50000,  diamonds: 0 },
      { id: 'sw5s5', kind: 'big_bonus',   rewardName: 'Diamond Proposal Ring',   coins: 150000, diamonds: 0 },
    ],
  },
  {
    id: 'sw6', name: 'Lunar New Year', active: false, seasonAnimationFileName: null,
    slots: [
      { id: 'sw6s1', kind: 'reward',      rewardName: 'Lion Dance',              coins: 2500,   diamonds: 0 },
      { id: 'sw6s2', kind: 'reward',      rewardName: 'Red Envelope',            coins: 2500,   diamonds: 0 },
      { id: 'sw6s3', kind: 'reward',      rewardName: 'Firecracker',             coins: 2500,   diamonds: 0 },
      { id: 'sw6s4', kind: 'small_bonus', rewardName: 'Golden Lion Dance',       coins: 50000,  diamonds: 0 },
      { id: 'sw6s5', kind: 'big_bonus',   rewardName: 'Diamond Imperial Dragon', coins: 150000, diamonds: 0 },
    ],
  },
  {
    id: 'sw7', name: 'Sports', active: false, seasonAnimationFileName: null,
    slots: [
      { id: 'sw7s1', kind: 'reward',      rewardName: 'Foam Finger',              coins: 2500,   diamonds: 0 },
      { id: 'sw7s2', kind: 'reward',      rewardName: 'Stadium Lights',           coins: 2500,   diamonds: 0 },
      { id: 'sw7s3', kind: 'reward',      rewardName: 'Touchdown',                coins: 2500,   diamonds: 0 },
      { id: 'sw7s4', kind: 'small_bonus', rewardName: 'Golden Goalpost',          coins: 50000,  diamonds: 0 },
      { id: 'sw7s5', kind: 'big_bonus',   rewardName: 'Diamond Championship Ring',coins: 150000, diamonds: 0 },
    ],
  },
  {
    id: 'sw8', name: 'Baseball', active: false, seasonAnimationFileName: null,
    slots: [
      { id: 'sw8s1', kind: 'reward',      rewardName: 'Baseball Cap',      coins: 2500,   diamonds: 0 },
      { id: 'sw8s2', kind: 'reward',      rewardName: 'Hot Dog',           coins: 2500,   diamonds: 0 },
      { id: 'sw8s3', kind: 'reward',      rewardName: 'Home Run',          coins: 2500,   diamonds: 0 },
      { id: 'sw8s4', kind: 'small_bonus', rewardName: 'Golden Bat',        coins: 50000,  diamonds: 0 },
      { id: 'sw8s5', kind: 'big_bonus',   rewardName: 'Diamond Grand Slam',coins: 150000, diamonds: 0 },
    ],
  },
  {
    id: 'sw9', name: 'Military', active: false, seasonAnimationFileName: null,
    slots: [
      { id: 'sw9s1', kind: 'reward',      rewardName: 'Dog Tags',      coins: 2500,   diamonds: 0 },
      { id: 'sw9s2', kind: 'reward',      rewardName: 'Salute',        coins: 2500,   diamonds: 0 },
      { id: 'sw9s3', kind: 'reward',      rewardName: 'Jet Flyover',   coins: 2500,   diamonds: 0 },
      { id: 'sw9s4', kind: 'small_bonus', rewardName: 'Golden Eagle',  coins: 50000,  diamonds: 0 },
      { id: 'sw9s5', kind: 'big_bonus',   rewardName: 'Diamond Shield',coins: 150000, diamonds: 0 },
    ],
  },
  {
    id: 'sw10', name: "St. Patrick's", active: false, seasonAnimationFileName: null,
    slots: [
      { id: 'sw10s1', kind: 'reward',      rewardName: 'Shamrock',               coins: 2500,   diamonds: 0 },
      { id: 'sw10s2', kind: 'reward',      rewardName: 'Lucky Horseshoe',        coins: 2500,   diamonds: 0 },
      { id: 'sw10s3', kind: 'reward',      rewardName: 'Leprechaun Hat',         coins: 2500,   diamonds: 0 },
      { id: 'sw10s4', kind: 'small_bonus', rewardName: 'Golden Pot of Gold',     coins: 50000,  diamonds: 0 },
      { id: 'sw10s5', kind: 'big_bonus',   rewardName: 'Diamond Clover Crown',   coins: 150000, diamonds: 0 },
    ],
  },
];
