...
export const mockUsers: User[] = [
  { id: 'u1', displayName: 'Aria Voss', handle: 'ariavoss', email: 'aria@example.com', role: 'creator', status: 'active', joined: '2025-03-12', followers: 14200, kyc: 'approved', country: 'US', walletBalance: 42000, totalEarned: 182000, totalStreams: 87, avatarColor: '#9966CC' },
  ...
  { id: 'u6', displayName: 'Carlos Duarte', handle: 'cduarte', email: 'carlos@example.com', role: 'creator', status: 'banned', joined: '2025-01-08', followers: 560, kyc: 'rejected', country: 'BR', walletBalance: 0, totalEarned: 4200, totalStreams: 11, avatarColor: '#48484A' },
  { id: 'u7', displayName: 'Sasha Bloom', handle: 'sashabloom', email: 'sasha@example.com', role: 'creator', status: 'active', joined: '2025-03-28', followers: 22100, kyc: 'approved', country: 'DE', walletBalance: 88000, totalEarned: 340000, totalStreams: 134, avatarColor: '#9966CC' },
